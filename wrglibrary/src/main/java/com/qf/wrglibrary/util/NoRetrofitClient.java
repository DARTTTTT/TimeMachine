...
public class NoRetrofitClient {
    ...
    public static NoRetrofitClient getInstance(Context context) {

        if (INSTANCE != null) {
            return INSTANCE;
        } else if (NoRetrofitClient.context == null) {
            NoRetrofitClient.context = context;
        }
        INSTANCE = new NoRetrofitClient(context);
     ...
     * 构造方法
     */
    private NoRetrofitClient(Context context) {
